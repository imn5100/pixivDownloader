...
def parse_illustration_list(html):
    if not html:
        return None
...
if __name__ == '__main__':
    webSiteHtml = HtmlDownloader.download(BASE_URL)
    banner_list = parse_illustration_list(webSiteHtml)
    print(banner_list)
